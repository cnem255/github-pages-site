...
export default function Dropdown() {
    return (
        <div className="dropdown pl-2 dropdown-end rounded-box ml-auto max-sm:ml-0 max-xs:pl-0">
            <label tabIndex={0} className="btn btn-ghost h-auto w-auto"><Bars3Icon className="h-10 w-10 text-white"/></label>
            <ul tabIndex={0} className="dropdown-content menu p-2 shadow frosted-glass-light-i dark:frosted-glass-dark-i mt-4 rounded-box w-52 xs:translate-x-[0%] max-xs:translate-x-[32%]">
