...
export default function Dropdown() {
    return (
        <div className="dropdown pl-2 max-sm:pl-0 dropdown-end rounded-box ml-auto max-sm:ml-0">
            <label tabIndex={0} className="btn btn-ghost h-auto w-auto"><NavigationIcon /></label>
            <ul tabIndex={0} className="dropdown-content menu p-2 shadow frosted-glass-light-i dark:frosted-glass-dark-i mt-4 rounded-box w-52 max-sm:translate-x-[35.25%]">
